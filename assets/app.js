...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["01-the-ask.html", "02-listening-first.html", "03-structure.html", "04-the-written-version.html", "05-the-spoken-version.html", "06-bad-news-and-disagreement.html"];
...
(function () {
  "use strict";
  var PASSPORT_KEY = "lwp-passport:communication";
  ...
  var FNS = {
    ...
    contrast: function (s) {
      ...
      if (hx.length < 2) return { error: "Give me two hex colours, for example  #FFFFFF #5C6B72" };
      function lum(h) {
        h = h.replace("#", "");
  ...
  if (strip) {
    ...
    var note = el("p", "pp-note", ppCount(got2) === 0
      ...
      : ppCount(got2) >= TOTAL_SESSIONS
        ? "Six of six. You finished the whole course - one message, rebuilt six times, and it lands now."
